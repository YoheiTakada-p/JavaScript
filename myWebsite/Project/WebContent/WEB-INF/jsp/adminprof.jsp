...
<head>
    <meta charset="UTF-8">
    <title>大喜利SNS - OGY | 管理者用マイページ</title>
    ...
    <div class="container" style="padding-top: 80px">
        ...
        <c:if test="${udb.id == userId or userId == 1}">
            ...
            <div class="col-md-2 offset-md-2" style="text-align: center">
                <div class="border-bottom">
                    <a href="adminupdatenameServlet"><font color=#696969>名前を変更</font></a>
                </div>
            </div>
            <div class="col-md-2" style="text-align: center">
                <div class="border-bottom">
                    <a href="adminupdatecommentServlet"><font color=#696969>ひと言を変更</font></a>
                </div>
            </div>
            <div class="col-md-2" style="text-align: center">
                <div class="border-bottom">
                    <a href="adminupdatepasswordServlet"><font color=#696969>パスワードを変更</font></a>
                </div>
            </div>
            <div class="col-md-2" style="text-align: center">
                <div class="border-bottom">
                    <a href="admindeleteuserServlet?id=${udb.id}"><font color=#696969>退　会</font></a>
                </div>
            </div>
        </div>
        </c:if>
...
<c:forEach var="user" items="${userList}" >
            <div class="col-md-6 offset-md-3" style="margin-bottom: 30px">
                <div class="border">
                    ...
                    <div class="border-top">
                        <div class="detail">
                            <font color=#696969>作成者</font><a class="mr-md-2" href="userprof2Servlet?id=${user.user_id}"><font color=#696969>「${user.name}」</font></a>
