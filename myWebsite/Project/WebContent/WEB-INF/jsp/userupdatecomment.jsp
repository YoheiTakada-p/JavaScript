...
<head>
    <meta charset="UTF-8">
    <title>大喜利SNS - OGY | ユーザ情報変更</title>
...
<header>
    ...
    <div class="container" style="padding-top: 80px">
        ...
        <form action="userupdatecomment" method="post">
            <fieldset>
                <div class="form-group row">
                    <label class="col-sm-5 col-form-label">ひと言</label>
                        <div class="col-sm-12">
                            <input value="${udb.comment}" type="text" class="form-control" name="comment">
                        </div>
                </div>
