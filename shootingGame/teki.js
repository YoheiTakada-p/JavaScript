...
function tekiShot(obj, speed) {
    ...
    //度数をラジアンに変換する(x * Math.PI/180)
    // an += rand(-10, 10) * Math.PI / 180;

    dx = Math.cos(an) * speed;//x座標
    dy = Math.sin(an) * speed;//y座標
