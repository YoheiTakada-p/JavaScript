...
//画面サイズ
const SCREEN_W = 320;//180
const SCREEN_H = 300;//320
...
//フィールドサイズ
const FIELD_W = SCREEN_W + 120;//*2
const FIELD_H = SCREEN_H + 40;//*2
...
function gameLoop() {
    ...
    if (gameWave == 0) {
        ...
        if (gameCount > 60 * 20) {
            ...
            teki.push(new Teki(2, rand(0, (FIELD_W / 2)) << 8, 0, 0, 200));
        }
    } else if (gameWave == 3) {
